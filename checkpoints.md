...
| #   | 测试点         | 测试内容                          | Qwen 3.5 | Kimi K2.5 | GLM-5 | Minimax 2.1 | Minimax 2.5 | 优先级 |
|-----|-------------|-------------------------------|----------|-----------|-------|-------------|-------------|-----|
| L1  | 超长上下文（非流式）  | 验证超长上下文请求的非流式输出               | ⏳        | ⏳         | ⏳     | ⏳           | ⏳           | P1  |
| L2  | 超长上下文（流式）   | 验证超长上下文请求的流式输出                | ⏳        | ⏳         | ⏳     | ⏳           | ⏳           | P1  |
| L3  | 超长上下文（边界验证） | 使用二分法逼近模型最大上下文长度              | ⏳        | ⏳         | ⏳     | ⏳           | ⏳           | P0  |
| L4  | 超长上下文（思考模式） | 验证超长上下文下reasoning_content的可用性 | ⏳        | ⏳         | ⏳     | ⏳           | ⏳           | P1  |
