...
| 文档 | 测试分类 | 测试点数 |
|------|---------|---------|
| [test_a_basic_reasoning.md](test_a_basic_reasoning.md) | A. 基础推理能力 | 8 |
| [test_b_advanced_generation.md](test_b_advanced_generation.md) | B. 高级生成功能 | 9 |
...
| [test_g_api_compatibility.md](test_g_api_compatibility.md) | G. API兼容性 | 4 |
| [test_h_quality.md](test_h_quality.md) | H. 质量评估 | 4 |
| [test_i_long_context.md](test_i_long_context.md) | I. 单项超长上下文验证 | 1 |
