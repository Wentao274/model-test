...
基于 checkpoints.md 文档设计的大模型推理能力测试框架，覆盖 10 大类共 103 个测试点，用于评估大模型推理服务（OpenAI 兼容 API）的功能完备性与生成质量。
...
每个测试用例的优先级在 `base/test_definitions.py` 中配置（合计 103 项）：P0 = 36，P1 = 56，P2 = 11。
